...
def final_kpi():
    ...
    merge5[['Promotor','% AMU Sekolah','% Pemukiman','% Ojol','% Kampus A','% Kampus B','% AVG Final KPI']] = merge5[['Promotor','% AMU Sekolah','% Pemukiman','% Ojol','% Kampus A','% Kampus B','% AVG Final KPI']].astype(float).round(1) 
